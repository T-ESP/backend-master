...
| [modeles.md](modeles.md) | Tech / ops | LLM utilisés (Groq primaire, Mistral fallback), critères de choix, alternatives |
...
| [changer-de-modele.md](changer-de-modele.md) | Ops | Comment switcher de modèle Groq/Mistral (choix du modèle, budget rate-limit) |
...
- **Je veux changer le modèle LLM** → [modeles.md](modeles.md)
